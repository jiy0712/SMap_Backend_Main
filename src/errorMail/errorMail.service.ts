...
<body style="margin:0;background:#f2f5fa;padding:24px;color:#202020">
  <div class="email-wrap" role="article" aria-label="SMap 제보 접수 확인 이메일">
    ...
    <div class="body">
      ...
      <div class="content">
        <p style="margin:0"><strong>제보 내용 요약</strong></p>
        <ul style="margin:10px 0 0 18px;padding:0">
          <li><strong>오류 내용 : </strong> ${location || '없음'}</li>
          <li><strong>뉴스 기사 링크 : </strong> ${newsUrl ? `<a href="${newsUrl}">${newsUrl}</a>` : '없음'}</li>
          <li><strong>이메일 : </strong> ${email || '없음'}</li>
        </ul>
      </div>

      <p class="small">빠른 시일 내에 검토하여 반영 여부 및 처리 결과를 안내드리겠습니다.</p>
